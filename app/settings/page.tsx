  ...
  return (
    <AppShell>
      ...
      <div className="flex w-full min-w-0 flex-col gap-4">
        {/* ──────────────────── 1. Identity ──────────────────── */}
        <SettingsSection title="小乖端" subtitle="内容会按小乖视角显示">
          <div className="rounded-[var(--app-radius)] border border-[var(--app-card-border)] bg-[var(--app-card-bg)] p-4 shadow-sm">
            <p className="text-sm font-semibold text-cocoa">这里是小乖的小空间</p>
            <p className="mt-1.5 text-xs text-[var(--app-muted)] leading-relaxed">小纸条、点赞和评论都会以&ldquo;小乖&rdquo;的身份留下。已读状态保存在本机。</p>
          </div>
        </SettingsSection>
