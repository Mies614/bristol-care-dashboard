...
export const THEME_PREVIEW_PRESETS: Record<AppThemeStyle, ThemePreviewConfig> = {
  ...
  "memory-film": {
    style: "memory-film",
    name: "时光胶片",
    description: "暖琥珀·复古纸·怀旧照片",
    tagline: "如同一卷老照片般温暖",
    inspiration: "胶片相机",
    bgGradient: "linear-gradient(135deg, #f5ede0 0%, #e8d8c0 100%)",
    panelBg: "rgba(250,245,238,0.65)",
    heroBg: "linear-gradient(135deg, rgba(160,120,80,0.20), rgba(160,120,80,0.06))",
    heroAccent: "#a07850",
    cardBg: "rgba(255,252,248,0.90)",
    cardBorder: "rgba(230,215,200,0.78)",
    cardRadius: "1.15rem",
    cardShadow: "0 4px 16px rgba(160,120,80,0.10), 0 1px 4px rgba(160,120,80,0.04)",
    btnBg: "linear-gradient(135deg, #a07850, #b89060)",
    btnText: "#fff",
    btnRadius: "0.5rem",
    btnShadow: "0 4px 12px rgba(160,120,80,0.20)",
    badgeBg: "rgba(160,120,80,0.12)",
    badgeText: "#8a6040",
    badgeShape: "rounded",
    navBg: "rgba(255,250,245,0.85)",
    navBorder: "rgba(230,215,200,0.70)",
    navItemActive: "rgba(160,120,80,0.22)",
    navItemInactive: "rgba(160,120,80,0.08)",
    navRadius: "0.75rem",
    decorationType: "tape",
    decorationColor: "rgba(200,170,140,0.45)",
  },
  ...
  "garden": {
    style: "garden",
    name: "晨间花园",
    description: "鼠尾草·薄荷·奶油绿",
    tagline: "像在花园里喝早茶",
    inspiration: "英式花园",
    bgGradient: "linear-gradient(135deg, #f2f7f0 0%, #e4ede2 100%)",
    panelBg: "rgba(248,252,246,0.65)",
    heroBg: "linear-gradient(135deg, rgba(107,138,106,0.18), rgba(107,138,106,0.06))",
    heroAccent: "#6b8a6a",
    cardBg: "#ffffff",
    cardBorder: "#d5e3d2",
    cardRadius: "1rem",
    cardShadow: "0 2px 10px rgba(107,138,106,0.08)",
    btnBg: "linear-gradient(135deg, #6b8a6a, #80a080)",
    btnText: "#fff",
    btnRadius: "0.5rem",
    btnShadow: "0 4px 12px rgba(107,138,106,0.22)",
    badgeBg: "rgba(107,138,106,0.12)",
    badgeText: "#4a6a4a",
    badgeShape: "rounded",
    navBg: "rgba(248,252,246,0.88)",
    navBorder: "rgba(210,225,210,0.75)",
    navItemActive: "rgba(107,138,106,0.22)",
    navItemInactive: "rgba(107,138,106,0.08)",
    navRadius: "0.75rem",
    decorationType: "dot-row",
    decorationColor: "rgba(107,138,106,0.35)",
  },
};
